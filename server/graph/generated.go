...
type ComplexityRoot struct {
	...
	Query struct {
		...
		GetRole     func(childComplexity int, name customTypes.Role) int
...
type QueryResolver interface {
	...
	GetRole(ctx context.Context, name customTypes.Role) (customTypes.Role, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.getRole":
		...
		return e.complexity.Query.GetRole(childComplexity, args["name"].(customTypes.Role)), true
...
func (ec *executionContext) field_Query_getRole_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 customTypes.Role
	if tmp, ok := rawArgs["name"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("name"))
		arg0, err = ec.unmarshalNRole2githubᚗcomᚋAntonioTrupacᚋsocialHabitsTrackerᚋgraphᚋcustomTypesᚐRole(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_getRole(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetRole(rctx, fc.Args["name"].(customTypes.Role))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _User_role(ctx context.Context, field graphql.CollectedField, obj *customTypes.User) (ret graphql.Marshaler) {
	...
	res := resTmp.(*customTypes.Role)
	fc.Result = res
	return ec.marshalORole2ᚖgithubᚗcomᚋAntonioTrupacᚋsocialHabitsTrackerᚋgraphᚋcustomTypesᚐRole(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputUserInput(ctx context.Context, obj interface{}) (customTypes.UserInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "role":
			...
			it.Role, err = ec.unmarshalORole2ᚖgithubᚗcomᚋAntonioTrupacᚋsocialHabitsTrackerᚋgraphᚋcustomTypesᚐRole(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalORole2ᚖgithubᚗcomᚋAntonioTrupacᚋsocialHabitsTrackerᚋgraphᚋcustomTypesᚐRole(ctx context.Context, v interface{}) (*customTypes.Role, error) {
	if v == nil {
		return nil, nil
	}
	var res = new(customTypes.Role)
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}
